...
from helpers import Conv2D_BN, shortcut_summation, contrastive_loss
...
class InceptionResnetV2:
    ...
    def stem(self, X):
        ...
        X = Conv2D_BN(X, filters=32, kernel_size=3, strides=2, padding="same", name="Stem_1_conv2d")
        # 149 x 149 x 32
        X = Conv2D_BN(X, filters=32, kernel_size=3, strides=1, padding="same", name="Stem_2_conv2d")
        # 147 x 147 x 32
        X = Conv2D_BN(X, filters=64, kernel_size=3, strides=1, padding="same", name="Stem_3_conv2d")
        # 147 x 147 x 64
        branch_1 = MaxPool2D(pool_size=3, strides=2, padding="same", name="Stem_4_pool_branch_1_1")(X)
        branch_2 = Conv2D_BN(X, filters=96, kernel_size=3, strides=2, padding="same",
                             name="Stem_4_conv2d_branch_2_1")
        # 73 x 73 x 160 (73 x 73 x 64 + 73 x 73 x 96)
        X = Concatenate(name="Stem_4_concatenate")([branch_1, branch_2])
        # branch 1
        branch_1 = Conv2D_BN(X, filters=64, kernel_size=1, strides=1, padding="same",
                             name="Stem_5_conv2d_branch_1_1")
        branch_1 = Conv2D_BN(branch_1, filters=96, kernel_size=3, strides=1, padding="same",
        ...
        branch_2 = Conv2D_BN(branch_2, filters=96, kernel_size=3, strides=1, padding="same",
                             name="Stem_5_conv2d_branch_2_4")
        X = Concatenate(name="Stem_5_concatenate")([branch_1, branch_2])
        # 71 x 71 x 192 (71 x 71 x 96 + 71 x 71 x 96)
        branch_1 = Conv2D_BN(X, filters=192, kernel_size=3, strides=2, padding="same", name="Stem_6_conv2d_branch_1_1")
        branch_2 = MaxPool2D(pool_size=3, strides=2, padding="same", name="Stem_6_conv2d_branch_2_1")(X)
        X = Concatenate(name="Stem_6_concatenate")([branch_1, branch_2])
    ...
    def resnet_A(self, X, scale=0.17, iteration=None):
        ...
        X = Concatenate(name="Resnet_A_{}_concatenate".format(iteration))(branches)
    ...
    def reduction_A(self, X):
        ...
        """
        # branch 1
        branch_1 = MaxPool2D(pool_size=3, strides=2, padding="same", name="Reduction_A_pool_branch_1")(X)
        # branch 2
        branch_2 = Conv2D_BN(X, filters=384, kernel_size=3, strides=2, padding="same",
        ...
        branch_3 = Conv2D_BN(branch_3, filters=384, kernel_size=3, strides=2, padding="same",
                             name="Reduction_A_conv2d_branch_3_3")
        branches = [branch_1, branch_2, branch_3]
        X = Concatenate(name="Reduction_A_concatenate")(branches)
        return X
    ...
    def resnet_B(self, X, scale=0.1, iteration=None):
        ...
        X = Concatenate(name="Resnet_B_{}_concatenate".format(iteration))(branches)
    ...
    def reduction_B(self, X):
        ...
        """
        # branch 1
        branch_1 = MaxPool2D(pool_size=3, strides=2, padding="same", name="Reduction_B_pool_branch_1")(X)
        # branch 2
        branch_2 = Conv2D_BN(X, filters=256, kernel_size=1, strides=1, padding="same",
                             name="Reduction_B_conv2d_branch_2_1")
        branch_2 = Conv2D_BN(branch_2, filters=384, kernel_size=3, strides=2, padding="same",
                             name="Reduction_B_conv2d_branch_2_2")
        # branch 3
        branch_3 = Conv2D_BN(X, filters=256, kernel_size=1, strides=1, padding="same",
                             name="Reduction_B_conv2d_branch_3_1")
        branch_3 = Conv2D_BN(branch_3, filters=288, kernel_size=3, strides=2, padding="same",
        ...
        branch_4 = Conv2D_BN(branch_4, filters=320, kernel_size=3, strides=2, padding="same",
                             name="Reduction_B_conv2d_branch_4_3")
        branches = [branch_1, branch_2, branch_3, branch_4]
        X = Concatenate(name="Reduction_B_concatenate")(branches)
        return X
    ...
    def resnet_C(self, X, scale=0.2, iteration=None):
        ...
        branches = [branch_1, branch_2]
        X = Concatenate(name="Resnet_C_{}_concatenate".format(iteration))(branches)
